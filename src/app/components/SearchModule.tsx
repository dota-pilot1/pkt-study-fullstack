...
const SPACE_LABELS: Record<string, string> = {
  SPRING_BOOT: "스프링 부트", SPRING_SECURITY: "스프링 시큐리티", SPRING_AI: "스프링 AI", SPRING_API: "API 설계 및 문서화", JAVA: "자바 노트", DB: "DB 테이블 설계", FRONTEND: "리액트 노트", FRONTEND_LIBRARY: "라이브러리 활용", FRONTEND_DOMAIN: "도메인 분석", JS_TS: "JS·TS 노트", BASIC_COMPONENTS: "기본 컴포넌트", PKT_FRONT_LEV1: "기본 화면 설계", COMPONENT_SKETCH: "컴포넌트 스케치",
};
